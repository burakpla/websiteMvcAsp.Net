<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Maıncourse_ekle.aspx.cs" Inherits="MyWebSite.Maıncourse_ekle" %>
...
<div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Yeni Yemek Ekle</h4>
            </div>
            <div class="card-body">
                <div class="row">
