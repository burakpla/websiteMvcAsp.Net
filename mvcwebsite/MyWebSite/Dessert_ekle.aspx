<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Dessert_ekle.aspx.cs" Inherits="MyWebSite.Dessert_ekle" %>
...
<div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Yeni Tatlı Ekle</h4>
            </div>
            <div class="card-body">
                <div class="row">
